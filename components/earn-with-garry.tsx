    ...
    <div className="container mx-auto flex flex-col items-center justify-normal px-6">
      <div className="flex flex-col items-center gap-6">
        ...
        <Button
          variant="default"
          size="lg"
          className="my-2 h-14 border-2 border-transparent bg-gary-yellow px-10 text-2xl text-black shadow-[0px_5px_0px_#D29200] rounded-full outline-none transition-all sm:hover:border-gary-yellow sm:hover:bg-white sm:hover:text-black dark:sm:hover:bg-white dark:sm:hover:text-black"
          onClick={() => {
