    ...
    >
      ...
      <div className="mt-4 flex flex-row items-center justify-between gap-2">
        <button
          ...
          className={`group flex-1 rounded-3xl border-0 ${activeButton === "ethereum" ? "bg-[#024365]" : "bg-[#FFEEDC]"
        ...
        >
          ...
          />
          <span
            className={`font-black ${activeButton === "ethereum" ? "text-white" : "text-black"
        ...
        <button
          ...
          className={`group flex-1 rounded-3xl border-0 ${activeButton === "polygon" ? "bg-[#024365]" : "bg-[#FFEEDC]"
            } flex h-[80px] w-[80px] flex-col items-center justify-center px-4 py-4 sm:h-12 sm:w-auto sm:flex-row sm:px-6 sm:py-2`}
        >
          <Image
          ...
          />
          <span
            className={`font-black ${activeButton === "polygon" ? "text-white" : "text-black"
              } text-[10px] sm:text-base`}
          >
        ...
        <button
          ...
          className={`group flex-1 rounded-3xl border-0 ${activeButton === "bsc" ? "bg-[#024365]" : "bg-[#FFEEDC]"
            } flex h-[80px] w-[80px] flex-col items-center justify-center px-4 py-4 sm:h-12 sm:w-auto sm:flex-row sm:px-6 sm:py-2`}
        >
          <Image
