    ...
    <div className="m-auto block text-center">
      <div className="mt-16 flex flex-col items-center">
        <Button
          onClick={handleClick}
          size="lg"
          className="mt-10 border-none bg-black/70 px-10 py-10 text-lg md:text-xl text-center whitespace-normal break-words max-w-[90%] mx-auto hover:!bg-black/80 z-[100]"
        >
