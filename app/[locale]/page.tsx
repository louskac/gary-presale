  ...
  return (
    <main className="h-screen overflow-y-scroll">
      ...
      >
        ...
        <div className="z-20 flex w-full flex-row justify-center mt-0 sm:mt-6">
      ...
      <section
        id="help-gary"
        className="bg-background px-4 py-12 sm:px-6 sm:pb-24"
      >
        <HelpGary />
      </section>
      <section
      ...
      <section
        id="save"
        className="-mt-32 flex bg-background px-4 sm:-mt-44 sm:px-6"
      >
        <SavePenguins />
      </section>
